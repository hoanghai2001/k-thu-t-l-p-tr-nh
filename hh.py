...
entry[1] = assetTypes[/ QQPlay window need to be inited first
if (false) {
...
// main.a012d.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
  ...
  if (isRuntime) {
    require("src/set window.boot();
}
tings.479c9.js");
    require("src/cocos2d-runtime.js");
    require("jsb-adapter/engine/index.js");
  } else {
    require("src/settings.479c9.js");
